...
(function ($) {
    ...
    $.artaraxTreeView = function (options) {
        ...
        function appendTreeItem(obj, hasChildren, checkedAttribute) {
            ...
            if (isUpdatable) {
                updatableHtml = '<img class="mng-img node-update" data-id="' + obj.Id + '"src="/resources/images/update.png"/>';
            }

            if (isDeletable) {
                deletableHtml = '<img class="mng-img node-delete" data-id="' + obj.Id + '" src="/resources/images/delete.png"/>';
            }
            ...
            if (hasChildren) {
                treeViewHtml += '<li><span class="' + nodeSignCssClass + '"></span><label class="' + selectedClass + '"><input type="radio" name="process" data-id="' + obj.Id + '" ' + checkedAttribute + ' class="chk" /> ' + obj.Title + '</label><span class="btn-wrpr">' + updatableHtml + deletableHtml + '</span>';
                treeViewHtml += '<ul>';
            } else {
                treeViewHtml += '<li><span class="node-none"></span><label class="' + selectedClass + '"><input type="radio" name="process" data-id="' + obj.Id + '" ' + checkedAttribute + ' class="chk leaf" /> ' + obj.Title + '</label><span class="btn-wrpr">' + updatableHtml + deletableHtml + '</span></li>';
            }
        }
